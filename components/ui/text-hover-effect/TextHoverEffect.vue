<template>
  ...
  >
    ...
    <text
      ...
      class="fill-transparent stroke-neutral-600 font-[helvetica] text-7xl font-bold "
    >
      {{ text }}
    </text>
    ...
    <text
      ...
      :stroke-width="strokeWidth"
      :style="strokeStyle"
      class="fill-transparent stroke-neutral-600 font-[helvetica] text-7xl font-bold dark:stroke-neutral-800"
    >
      {{ text }}
    </text>
