<template>
  <div
    :class="
      cn(
        'row-span-1 rounded-xl group/bento hover:shadow-xl transition duration-200 shadow-none p-4  border-white/[0.2] border  justify-between flex flex-col space-y-4',
        props.class,
      )
    "
  >
