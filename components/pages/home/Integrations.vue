...
<template>
  <div>
    <SectionTitle
      ...
      description="Connect with over 200+ popular business tools to create a truly unified workflow."
    />

    <ClientOnly>
    <div
      ref="containerRef"
      class="relative flex w-full items-center justify-center overflow-hidden rounded-lg p-10 md:shadow-xl"
    >
      <div
